...
lossOfThust = 0.5  # Ex2.1 50% loss of thrust
# lossOfThust = 0.67  # Ex2.2 67% loss of thrust

# Instantiate controller and start sensors
# customController = LQRController(driver, lossOfThust)  # LQR controller
customController = AdaptiveController(driver, lossOfThust)  # Adaptive controller
